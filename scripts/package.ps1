...
Copy-Item -Path scripts\vendor\xaudio2_9redist.dll -Destination $PackagePath\xaudio2_9redist.dll -Force
...
& "..\..\..\scripts\vendor\msdetours\setdll.exe" "-d:superhotmcc.dll" "xaudio2_9redist.dll"
Set-Location "..\..\.."
